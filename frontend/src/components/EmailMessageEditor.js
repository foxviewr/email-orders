    ...
    return (
        ...
        >
            <div className="flex flex-col-reverse sm:flex-row">
                <div className="hidden sm:flex flex-none items-center">
                    <svg
                        fill="none"
                        stroke="white"
                        strokeLinecap="round"
                ...
                <div className="flex flex-auto justify-end mt-2 sm:ml-12 text-sm">
                    <textarea
                        id="email_answer"
                        name="email_answer"
                        rows="4"
                        ...
                        value={replyMessage}
                        className="p-2.5 w-full text-white text-sm rounded-lg border border-gray-600 bg-gray-700 placeholder-gray-400"
                        required
